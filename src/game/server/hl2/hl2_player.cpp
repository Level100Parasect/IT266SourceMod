...
#define	FLASH_CHARGE_TIME	 20.0f	// 100 units / 2 secs
...
// SUIT POWER DEVICES
//
#define SUITPOWER_CHARGE_RATE	3.5											// louis
...
#ifdef HL2_EPISODIC
	CSuitPowerDevice SuitDeviceFlashlight( bits_SUIT_DEVICE_FLASHLIGHT, 50.0 );	// louis
#else
	CSuitPowerDevice SuitDeviceFlashlight( bits_SUIT_DEVICE_FLASHLIGHT, 2.222 );	// 100 units in 45 second
#endif
CSuitPowerDevice SuitDeviceBreather( bits_SUIT_DEVICE_BREATHER, 3.5f );		// louis
