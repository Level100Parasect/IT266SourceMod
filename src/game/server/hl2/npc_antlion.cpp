...
ConVar	sk_antlion_swipe_damage( "sk_antlion_swipe_damage", "30" );
ConVar	sk_antlion_jump_damage( "sk_antlion_jump_damage", "30" );
ConVar  sk_antlion_air_attack_dmg( "sk_antlion_air_attack_dmg", "30" );
